...
def SEResNet(input_shape=None,
    ...
    # Commented out by Christian Jamtheim Gustafsson 2020-06-24. 
    # Can not otherwise be used to load other weights. 
    ...
    # load weights
    # Added this by Christian Jamtheim Gustafsson 2020-06-24
